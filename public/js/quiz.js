  ...
  $.dlxQuiz = function ( element, options ) {
    var plugin = this,
      ...
      defaults = {
        ...
        quizScore_text: "You answered <input type='number' id='score' value='%totalScore' readonly> out of <input type='number' id='total_q' readonly  value='%totalQuestions' > questions correctly",
